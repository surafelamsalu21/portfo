!(function (t) {
			...
			+(function (t) {
				...
				(n.VERSION = "3.3.7"),
					...
					(n.prototype.fixTitle = function () {
						...
						(t.attr("title") ||
							"string" !=
								typeof t.attr("data-original-title")) &&
							t
								.attr(
									"data-original-title",
									t.attr("title") || ""
					...
					(n.prototype.getCalculatedOffset = function (
						t,
						e,
						n,
						i
	...
	aWFY: function (t, e, n) {
		...
		(function (t) {
			...
			function o() {
				t('nav li a[href=".' + location.pathname + '"]').addClass(
					"active"
				),
					"/" == location.pathname &&
						t('nav li a[href="./index.html"]').addClass(
							"active"
						);
			}
			function r() {
				...
				(e.VERSION = "3.3.7"),
					...
					(e.prototype.process = function () {
						var t,
							...
							s = this.activeTarget;
						if (
							(this.scrollHeight != n && this.refresh(),
							e >= i)
						)
							return (
								s != (t = r[r.length - 1]) &&
						...
						if (s && e < o[0])
							return (
								(this.activeTarget = null), this.clear()
							);
						for (t = o.length; t--; )
							s != r[t] &&
								e >= o[t] &&
		...
		!(function (e, n) {
			...
			function P(t, e, n, i) {
				...
				if (
					...
					for (
						a = yt.map(T(o, "script"), A), l = a.length;
						p < f;
						p++
					)
						(u = o),
			...
			function H(t) {
				if (t in me) return t;
				for (
					var e = t[0].toUpperCase() + t.slice(1), n = ge.length;
					n--;
			...
			var Ct = (function (t) {
				...
				function g(t, e, n, i, o) {
					for (
						var r, s = [], a = 0, l = t.length, u = null != e;
						a < l;
						a++
					)
						(r = t[a]) &&
				...
				(x = e.support = {}),
					(C = e.isXML =
						function (t) {
							var e =
								t &&
								(t.ownerDocument || t).documentElement;
						...
						function (t) {
							...
							return i !== j &&
								...
								? ((j = i),
								  ...
								  (x.getElementsByTagName = o(function (
										t
								  ) {
										return (
											t.appendChild(
					...
					(e.attr = function (t, e) {
						...
						var n = w.attrHandle[e.toLowerCase()],
							i =
								n &&
								V.call(w.attrHandle, e.toLowerCase())
									? n(t, e, !I)
									: void 0;
						return void 0 !== i
							? i
			...
			(yt.fn.ready = function (t) {
				...
				("loading" !== st.readyState &&
					!st.documentElement.doScroll)
			...
			!(function () {
				...
				n.setAttribute("type", "radio"),
					...
					(vt.noCloneChecked = !!e.cloneNode(!0).lastChild
						.defaultValue);
			})();
			...
			(yt.event = {
				...
				dispatch: function (t) {
					...
					if (
						...
						!c.preDispatch ||
							!1 !== c.preDispatch.call(this, a))
					) {
						for (
							s = yt.event.handlers.call(this, a, u),
								e = 0;
				...
				handlers: function (t, e) {
					...
					return (
						(u = this),
						l < e.length &&
							a.push({ elem: u, handlers: e.slice(l) }),
						a
					);
				},
			...
			yt.extend({
				...
				(yt.cssHooks.marginLeft = R(
					vt.reliableMarginLeft,
					function (t, e) {
						if (e)
							return (
					...
					return (
						e ||
							(vt.createHTMLDocument
								? ((e =
										st.implementation.createHTMLDocument(
											""
										)),
						...
						"static" === c && (t.style.position = "relative"),
							...
							u
								...
								: ((s = parseFloat(r) || 0),
								  (o = parseFloat(l) || 0)),
							yt.isFunction(e) &&
								(e = e.call(t, n, yt.extend({}, a))),
							null != e.top && (f.top = e.top - a.top + s),
							null != e.left &&
								(f.left = e.left - a.left + o),
		...
		(function (t) {
			+(function (t) {
				...
				(i.VERSION = "3.3.7"),
					...
					(i.prototype.addAriaAndCollapsedClass = function (
						t,
						e
					) {
						var n = t.hasClass("in");
										...
										value: function (t, e) {
											...
											this.timeout =
												setTimeout(
													function () {
														e =
															s.htmlParser.backSpaceHtmlChars(
																t,
																e,
																n
															);
										...
										value: function (t) {
											if (
												...
												var e = t
													? "infinite"
													: 0;
												this.cursor.style.animationIterationCount =
													e;
											}
										},
									},
